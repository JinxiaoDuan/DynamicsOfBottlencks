...
{ 
	...
	{ 
		...
		char filename[100];
		if(date>=10)	sprintf (filename,"generated data/treesize_step=%d_%d.csv",step,date);
		if(date<10)		sprintf (filename,"generated data/treesize_step=%d_0%d.csv",step,date);
